document.addEventListener('DOMContentLoaded', function() {
    ...
    var botaoCEspecifica = document.querySelector('.botao-opcao:nth-of-type(1)');
    var botaoCTotal = document.querySelector('.botao-opcao:nth-of-type(2)');
    ...
    botaoCEspecifica.addEventListener('click', function() {
        ...
        blocoSubtitulo.textContent = "Escolha onde deseja exibir as informações e em seguida preencha os campos correspondentes";
    ...
    botaoCTotal.addEventListener('click', function() {
        ...
        botaoEnviar.style.display = 'flex'; // Mostrar botão de envio
        selectTabelas.style.display = 'block'; // Mostrar o select
        blocoSubtitulo.textContent = "Escolha onde deseja exibir as informações";
    });
});
